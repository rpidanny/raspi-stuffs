...
$(function() {
	...
	$("#chatEntries").slimScroll({height: '400px',allowPageScroll: true, start : 'bottom' ,scrollBy:'400px'});
...
function forwardfxn(){
	socket.emit('message',"iBot go forward");
	addMessage("iBot go forward", "Me", new Date().toISOString(), true);

	//$("#forward").button('loading');
}
function backwardfxn(){
	socket.emit('message', "iBot go backward");
	addMessage("iBot go backward", "Me", new Date().toISOString(), true);

	//$("#backward").button('loading');
}
function leftfxn(){
	socket.emit('message', "iBot go left");
	addMessage("iBot go left", "Me", new Date().toISOString(), true);

	//$("#left").button('loading');
}
function rightfxn(){
	socket.emit('message', "iBot go right");
	addMessage("iBot go right", "Me", new Date().toISOString(), true);

	//$("#right").button('loading');
}
function stopfxn(){
	socket.emit('message', "iBot go stop");
	addMessage("iBot go stop", "Me", new Date().toISOString(), true);
...
function addMessage(msg, pseudo, date, self) {
	...
	//$("#chatEntries").slimScroll({scrollBy:'$("#chatEntries").height()'});
